...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'px-4 py-1 disabled:bg-gray-200 disabled:border-gray-200 disabled:cursor-not-allowed rounded-md flex items-center justify-center cursor-pointer flex items-center justify-center disabled:cursor-not-allowed';
